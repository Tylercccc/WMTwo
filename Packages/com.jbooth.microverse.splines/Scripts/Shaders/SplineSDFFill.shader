    ...
    SubShader
    {
        Pass
        {
            ...
            float4 frag(v2f i) : SV_Target
            {
                ...
                bool area = (_Info.y > 0.5 || _IsArea > 0.5);
                float maxSDF = _MaxSDF * 1.5;
                ...
                // we want to return the last if we're in the negative space of the SDF
                // bu tif not, we return the minimum SDF
                // This used to be expressed as last.x < dw, but that causes positions
                // to be wrong while combining..
