...
namespace JBooth.MicroVerseCore
{
    ...
    public class FilterSet : ISerializationCallbackReceiver
    {
        ...
        static Vector4[] terrainLayerWeights = new Vector4[32];
        ...
        public void PrepareTransform(Transform transform, Terrain terrain, Material material, List<string> keywords)
        {
