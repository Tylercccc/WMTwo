...
namespace JBooth.MicroVerseCore
{
...
#endif
    {
        ...
        public void ApplyTreeClear(TreeData td)
        {
            ...
            filterSet.PrepareTransform(this.transform, td.terrain, material, keywordBuilder.keywords);
        ...
        public void ApplyDetailClear(DetailData dd)
        {
            ...
            filterSet.PrepareTransform(this.transform, dd.terrain, material, keywordBuilder.keywords);
            keywordBuilder.Assign(material);
